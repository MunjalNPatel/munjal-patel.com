...
(function(){
  ...
  const NODES=[
    {id:0,label:'KYRA',name:'Kyra Solutions',role:'Program Hub',color:'#0ea5e9',roleColor:'#38bdf8',size:32,
    ...
    {id:1,label:'FL',name:'Florida Prepaid',role:'Business Analyst',color:'#fb923c',roleColor:'#fdba74',size:19,
    ...
    {id:2,label:'IN',name:'Indiana DOE',role:'Business Analyst',color:'#fb923c',roleColor:'#fdba74',size:19,
    ...
    {id:3,label:'RLD',name:'NM Regulatory & Licensing',role:'Sr. Business Analyst',color:'#f472b6',roleColor:'#f9a8d4',size:21,
     platform:'Salesforce CRM',impact:'Regulatory licensing & case management',period:'2022–2025',
     tx:0.35,ty:0.82,connects:[0,4,5]},
    {id:4,label:'CCD',name:'NM Cannabis Control Dept.',role:'Project Manager',color:'#38bdf8',roleColor:'#60a5fa',size:21,
     platform:'Salesforce CRM',impact:'Cannabis licensing & compliance management',period:'2022–2025',
     tx:0.46,ty:0.82,connects:[0,3,5]},
    {id:5,label:'NMMB',name:'NM Medical Board',role:'Project Manager',color:'#38bdf8',roleColor:'#60a5fa',size:21,
     platform:'Salesforce CRM',impact:'Medical licensing & practitioner management',period:'2022–2025',
     tx:0.57,ty:0.82,connects:[0,3,4]},
    {id:6,label:'IL',name:'Illinois DCR',role:'Project Manager',color:'#38bdf8',roleColor:'#60a5fa',size:24,
     platform:'Salesforce CRM',impact:'Cannabis inspection management system',period:'2024–Present',
     tx:0.70,ty:0.82,connects:[0]},
    {id:7,label:'OH',name:'Ohio Dept. of Health',role:'Tech Lead / DPM',color:'#818cf8',roleColor:'#a5b4fc',size:25,
    ...
    {id:8,label:'MI',name:'Michigan EGLE',role:'Project Manager',color:'#38bdf8',roleColor:'#60a5fa',size:25,
